...
function renderVehicleSizes() {
  ...
  let html = `<div class="grid grid-cols-2 gap-6 sm:gap-5">`;
  ...
  vehicleList.forEach(v => {
    ...
    html += `
    <button type="button" class="vehicle-option option-card text-left rounded-3xl ${wrapClasses} p-7 sm:p-8 transition-all flex flex-col" data-vehicle="${v.id}">
